...
namespace WorkerService.Infrastructure.Migrations
{
    ...
    [Migration("20220109030723_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkerService.Application.Entities.OtherThing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("WorkerService.Application.Entities.Something", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("WorkerService.Application.Entities.Something", b =>
                {
                    b.HasOne("WorkerService.Application.Entities.OtherThing", "OtherThing")
                        .WithMany()
