dotnet new herald-worker -n E_SQS_POSTGRE -o E_SQS_POSTGRE -f=netcoreapp3.1 -q=sqs -d=postgre
...
dotnet new herald-worker -n E_SQS_MYSQL -o E_SQS_MYSQL -f=netcoreapp3.1 -q=sqs -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_SQS_SQLSERVER -o E_SQS_SQLSERVER -f=netcoreapp3.1 -q=sqs -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_SQS_NONE -o E_SQS_NONE -f=netcoreapp3.1 -q=sqs -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_KAKFA_POSTGRE -o E_KAKFA_POSTGRE -f=netcoreapp3.1 -q=kafka -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_KAKFA_MYSQL -o E_KAKFA_MYSQL -f=netcoreapp3.1 -q=kafka -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_KAKFA_SQLSERVER -o E_KAKFA_SQLSERVER -f=netcoreapp3.1 -q=kafka -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_KAKFA_NONE -o E_KAKFA_NONE -f=netcoreapp3.1 -q=kafka -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_RABBITMQ_POSTGRE -o E_RABBITMQ_POSTGRE -f=netcoreapp3.1 -q=rabbitmq -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_RABBITMQ_MYSQL -o E_RABBITMQ_MYSQL -f=netcoreapp3.1 -q=rabbitmq -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_RABBITMQ_SQLSERVER -o E_RABBITMQ_SQLSERVER -f=netcoreapp3.1 -q=rabbitmq -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_RABBITMQ_NONE -o E_RABBITMQ_NONE -f=netcoreapp3.1 -q=rabbitmq -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_AZURE_POSTGRE -o E_AZURE_POSTGRE -f=netcoreapp3.1 -q=azure -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_AZURE_MYSQL -o E_AZURE_MYSQL -f=netcoreapp3.1 -q=azure -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_AZURE_SQLSERVER -o E_AZURE_SQLSERVER -f=netcoreapp3.1 -q=azure -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_AZURE_NONE -o E_AZURE_NONE -f=netcoreapp3.1 -q=azure -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_NONE_POSTGRE -o E_NONE_POSTGRE -f=netcoreapp3.1 -q=none -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
docker-compose -f 'C:\Users\tcfialho\TestHeraldWorker\E_NONE_POSTGRE\.docker\docker-compose.yml' up -d --build
dotnet clean "c:\Users\tcfialho\TestHeraldWorker\E_NONE_POSTGRE\E_NONE_POSTGRE.sln"
dotnet build "c:\Users\tcfialho\TestHeraldWorker\E_NONE_POSTGRE\E_NONE_POSTGRE.sln"
nohup dotnet "run" "--project" "c:\Users\tcfialho\TestHeraldWorker\E_NONE_POSTGRE\E_NONE_POSTGRE.Api\E_NONE_POSTGRE.Worker.csproj" &>/dev/null &
sleep 10;
...
TASKKILL //IM "E_NONE_POSTGRE.Worker.exe" //F //T

dotnet new herald-worker -n E_NONE_MYSQL -o E_NONE_MYSQL -f=netcoreapp3.1 -q=none -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
docker-compose -f 'C:\Users\tcfialho\TestHeraldWorker\E_NONE_MYSQL\.docker\docker-compose.yml' up -d --build
dotnet clean "c:\Users\tcfialho\TestHeraldWorker\E_NONE_MYSQL\E_NONE_MYSQL.sln"
dotnet build "c:\Users\tcfialho\TestHeraldWorker\E_NONE_MYSQL\E_NONE_MYSQL.sln"
nohup dotnet "run" "--project" "c:\Users\tcfialho\TestHeraldWorker\E_NONE_MYSQL\E_NONE_MYSQL.Api\E_NONE_MYSQL.Worker.csproj" &>/dev/null &
sleep 10;
...
TASKKILL //IM "E_NONE_MYSQL.Worker.exe" //F //T

dotnet new herald-worker -n E_NONE_SQLSERVER -o E_NONE_SQLSERVER -f=netcoreapp3.1 -q=none -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
docker-compose -f 'C:\Users\tcfialho\TestHeraldWorker\E_NONE_SQLSERVER\.docker\docker-compose.yml' up -d --build
dotnet clean "c:\Users\tcfialho\TestHeraldWorker\E_NONE_SQLSERVER\E_NONE_SQLSERVER.sln"
dotnet build "c:\Users\tcfialho\TestHeraldWorker\E_NONE_SQLSERVER\E_NONE_SQLSERVER.sln"
nohup dotnet "run" "--project" "c:\Users\tcfialho\TestHeraldWorker\E_NONE_SQLSERVER\E_NONE_SQLSERVER.Api\E_NONE_SQLSERVER.Worker.csproj" &>/dev/null &
sleep 10;
...
TASKKILL //IM "E_NONE_SQLSERVER.Worker.exe" //F //T

dotnet new herald-worker -n E_NONE_NONE -o E_NONE_NONE -f=netcoreapp3.1 -q=none -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
docker-compose -f 'C:\Users\tcfialho\TestHeraldWorker\E_NONE_NONE\.docker\docker-compose.yml' up -d --build
dotnet clean "c:\Users\tcfialho\TestHeraldWorker\E_NONE_NONE\E_NONE_NONE.sln"
dotnet build "c:\Users\tcfialho\TestHeraldWorker\E_NONE_NONE\E_NONE_NONE.sln"
nohup dotnet "run" "--project" "c:\Users\tcfialho\TestHeraldWorker\E_NONE_NONE\E_NONE_NONE.Api\E_NONE_NONE.Worker.csproj" &>/dev/null &
sleep 10;
curl -k -s -o /dev/null -w "Code: %{http_code}" -X 'GET' 'https://localhost:5001/E_NONE_NONE/21331410'
TASKKILL //IM "E_NONE_NONE.Worker.exe" //F //T

dotnet new herald-worker -n NE_SQS_POSTGRE -o NE_SQS_POSTGRE -f=netcoreapp3.1 -ne -q=sqs -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_SQS_MYSQL -o NE_SQS_MYSQL -f=netcoreapp3.1 -ne -q=sqs -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_SQS_SQLSERVER -o NE_SQS_SQLSERVER -f=netcoreapp3.1 -ne -q=sqs -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_SQS_NONE -o NE_SQS_NONE -f=netcoreapp3.1 -ne -q=sqs -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_KAKFA_POSTGRE -o NE_KAKFA_POSTGRE -f=netcoreapp3.1 -ne -q=kafka -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_KAKFA_MYSQL -o NE_KAKFA_MYSQL -f=netcoreapp3.1 -ne -q=kafka -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_KAKFA_SQLSERVER -o NE_KAKFA_SQLSERVER -f=netcoreapp3.1 -ne -q=kafka -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_KAKFA_NONE -o NE_KAKFA_NONE -f=netcoreapp3.1 -ne -q=kafka -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_RABBITMQ_POSTGRE -o NE_RABBITMQ_POSTGRE -f=netcoreapp3.1 -ne -q=rabbitmq -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_RABBITMQ_MYSQL -o NE_RABBITMQ_MYSQL -f=netcoreapp3.1 -ne -q=rabbitmq -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_RABBITMQ_SQLSERVER -o NE_RABBITMQ_SQLSERVER -f=netcoreapp3.1 -ne -q=rabbitmq -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_RABBITMQ_NONE -o NE_RABBITMQ_NONE -f=netcoreapp3.1 -ne -q=rabbitmq -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_AZURE_POSTGRE -o NE_AZURE_POSTGRE -f=netcoreapp3.1 -ne -q=azure -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_AZURE_MYSQL -o NE_AZURE_MYSQL -f=netcoreapp3.1 -ne -q=azure -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_AZURE_SQLSERVER -o NE_AZURE_SQLSERVER -f=netcoreapp3.1 -ne -q=azure -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_AZURE_NONE -o NE_AZURE_NONE -f=netcoreapp3.1 -ne -q=azure -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_NONE_POSTGRE -o NE_NONE_POSTGRE -f=netcoreapp3.1 -ne -q=none -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
docker-compose -f 'C:\Users\tcfialho\TestHeraldWorker\NE_NONE_POSTGRE\.docker\docker-compose.yml' up -d --build
dotnet clean "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_POSTGRE\NE_NONE_POSTGRE.sln"
dotnet build "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_POSTGRE\NE_NONE_POSTGRE.sln"
nohup dotnet "run" "--project" "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_POSTGRE\NE_NONE_POSTGRE.Api\NE_NONE_POSTGRE.Worker.csproj" &>/dev/null &
sleep 10;
curl -k -s -o /dev/null -w "Code: %{http_code}" -X 'GET' 'https://localhost:5001/NE_NONE_POSTGRE'
TASKKILL //IM "NE_NONE_POSTGRE.Worker.exe" //F //T

dotnet new herald-worker -n NE_NONE_MYSQL -o NE_NONE_MYSQL -f=netcoreapp3.1 -ne -q=none -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
docker-compose -f 'C:\Users\tcfialho\TestHeraldWorker\NE_NONE_MYSQL\.docker\docker-compose.yml' up -d --build
dotnet clean "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_MYSQL\NE_NONE_MYSQL.sln"
dotnet build "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_MYSQL\NE_NONE_MYSQL.sln"
nohup dotnet "run" "--project" "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_MYSQL\NE_NONE_MYSQL.Api\NE_NONE_MYSQL.Worker.csproj" &>/dev/null &
sleep 10;
curl -k -s -o /dev/null -w "Code: %{http_code}" -X 'GET' 'https://localhost:5001/NE_NONE_MYSQL'
TASKKILL //IM "NE_NONE_MYSQL.Worker.exe" //F //T

dotnet new herald-worker -n NE_NONE_SQLSERVER -o NE_NONE_SQLSERVER -f=netcoreapp3.1 -ne -q=none -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
docker-compose -f 'C:\Users\tcfialho\TestHeraldWorker\NE_NONE_SQLSERVER\.docker\docker-compose.yml' up -d --build
dotnet clean "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_SQLSERVER\NE_NONE_SQLSERVER.sln"
dotnet build "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_SQLSERVER\NE_NONE_SQLSERVER.sln"
nohup dotnet "run" "--project" "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_SQLSERVER\NE_NONE_SQLSERVER.Api\NE_NONE_SQLSERVER.Worker.csproj" &>/dev/null &
sleep 10;
curl -k -s -o /dev/null -w "Code: %{http_code}" -X 'GET' 'https://localhost:5001/NE_NONE_SQLSERVER'
TASKKILL //IM "NE_NONE_SQLSERVER.Worker.exe" //F //T

dotnet new herald-worker -n NE_NONE_NONE -o NE_NONE_NONE -f=netcoreapp3.1 -ne -q=none -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
docker-compose -f 'C:\Users\tcfialho\TestHeraldWorker\NE_NONE_NONE\.docker\docker-compose.yml' up -d --build
dotnet clean "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_NONE\NE_NONE_NONE.sln"
dotnet build "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_NONE\NE_NONE_NONE.sln"
nohup dotnet "run" "--project" "c:\Users\tcfialho\TestHeraldWorker\NE_NONE_NONE\NE_NONE_NONE.Api\NE_NONE_NONE.Worker.csproj" &>/dev/null &
sleep 10;
TASKKILL //IM "NE_NONE_NONE.Worker.exe" //F //T