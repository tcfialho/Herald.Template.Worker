...
dotnet new herald-worker -n E_NONE_POSTGRE -o E_NONE_POSTGRE -f=net6.0 -q=none -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_NONE_MYSQL -o E_NONE_MYSQL -f=net6.0 -q=none -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_NONE_SQLSERVER -o E_NONE_SQLSERVER -f=net6.0 -q=none -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n E_NONE_NONE -o E_NONE_NONE -f=net6.0 -q=none -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_NONE_POSTGRE -o NE_NONE_POSTGRE -f=net6.0 -ne -q=none -d=postgre
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_NONE_MYSQL -o NE_NONE_MYSQL -f=net6.0 -ne -q=none -d=mysql
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_NONE_SQLSERVER -o NE_NONE_SQLSERVER -f=net6.0 -ne -q=none -d=sqlserver
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
...
dotnet new herald-worker -n NE_NONE_NONE -o NE_NONE_NONE -f=net6.0 -ne -q=none -d=none
docker kill $(docker ps -q)
docker rm $(docker ps -a -q)
docker network prune --force
